...
<html  >
    <head>
        ...
        <script>
            function View_Customer1(name, phone, amount, date, walletaddress) {
                var f = document.form;
                f.method = "post";
                f.action = 'view_withdrawal_one.jsp?name=' + name + "&phone=" + phone +
                        "&amount=" + amount + "&date=" + date + "&walletaddress=" + walletaddress;
                f.submit();
            }
                        ...
                        <table class="table isSearch" cellspacing="0" data-empty="No matching customer found">
                            <thead>
                                <tr class="table-heads ">
                                    ...
                                    <th class="head-item mbr-fonts-style display-7">WITHDRAWAL AMOUNT</th>
                            ...
                            <tbody>
                                <tr> 
                                    ...
                                    <td class="body-item mbr-fonts-style display-7">eN 207.000</td>
                                ...
                                <tr> 
                                    ...
                                    <td class="body-item mbr-fonts-style display-7">+23470654822</td>
                                    <td class="body-item mbr-fonts-style display-7">eN 787.000</td>
                                    <td class="body-item mbr-fonts-style display-7">2022-08-07</td>
                                    <td class="body-item mbr-fonts-style display-7">AS5445511</td>
                                    <td class="body-item mbr-fonts-style display-7">
                                        <button type="button" onclick="View_Customer2(
                                                        'Zainab Lawwalu',
                                                        '+23470654822',
                                                        'eN 787.000',
                                                        '2022-08-07',
                                                        'AS5445511');"
                                                class="btn btn-primary display-4">View Customer</button>
                                    </td>
                                </tr>
                                <tr> 
                                    <td class="body-item mbr-fonts-style display-7">Hamid Murtala</td>
                                    <td class="body-item mbr-fonts-style display-7">+23470654822</td>
                                    <td class="body-item mbr-fonts-style display-7">eN 117.000</td>
                                    <td class="body-item mbr-fonts-style display-7">2022-08-07</td>
                                    <td class="body-item mbr-fonts-style display-7">AS5445511</td>
                                    <td class="body-item mbr-fonts-style display-7">
                                        <button type="button" onclick="View_Customer3(
                                                        'Hamid Murtala',
                                                        '+23470654822',
                                                        'eN 117.000',
                                                        '2022-08-07',
                                ...
                                <tr> 
                                    ...
                                    <td class="body-item mbr-fonts-style display-7">+23470654822</td>
                                    <td class="body-item mbr-fonts-style display-7">eN 917.000</td>
                                    <td class="body-item mbr-fonts-style display-7">2022-08-07</td>
                                    <td class="body-item mbr-fonts-style display-7">AS5445511</td>
                                    <td class="body-item mbr-fonts-style display-7">
                                        <button type="button" onclick="View_Customer4(
                                                        'Awwal Abdullahi',
                                                        '+23470654822',
                                                        'eN 917.000',
                                                        '2022-08-07',
                                ...
                                <tr> 
                                    ...
                                    <td class="body-item mbr-fonts-style display-7">+23470654822</td>
                                    <td class="body-item mbr-fonts-style display-7">eN 17.000</td>
                                    <td class="body-item mbr-fonts-style display-7">2022-08-07</td>
                                    <td class="body-item mbr-fonts-style display-7">AS5445511</td>
                                    <td class="body-item mbr-fonts-style display-7">
                                        <button type="button" onclick="View_Customer5(
                                                        'Simon Innocent',
                                                        '+23470654822',
                                                        'eN 17.000',
                                                        '2022-08-07',
                                ...
                                <tr> 
                                    ...
                                    <td class="body-item mbr-fonts-style display-7">+23470654822</td>
                                    <td class="body-item mbr-fonts-style display-7">eN 37.000</td>
                                    <td class="body-item mbr-fonts-style display-7">2022-08-07</td>
                                    <td class="body-item mbr-fonts-style display-7">AS5445511</td>
                                    <td class="body-item mbr-fonts-style display-7">
                                        <button type="button" onclick="View_Customer6(
                                                        'Abdulkadir Zahur',
                                                        '+23470654822',
                                                        'eN 37.000',
                                                        '2022-08-07',
